...
class PageEditAkun extends StatefulWidget {
  String kode;
  PageEditAkun(this.kode);
  @override
  _PageEditAkunState createState() => _PageEditAkunState(this.kode);
}
...
class _PageEditAkunState extends State<PageEditAkun> {
  ...
  simpanData(context) async {
    ...
    var res = await http.post(Uri.encodeFull(Config.ipWeb + "updateUser/$kode"),
        body: body,
        headers: {
          'Authorization': 'Bearer $token',},);
    ...
    if (res.statusCode == 200) {
      ...
      Config.alert(2, "Gagal mengubah data, Silahkan periksa kembali data anda!");
