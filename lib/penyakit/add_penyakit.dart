...
class PageAddPeyakit extends StatefulWidget {
  @override
  _PageAddPeyakitState createState() => _PageAddPeyakitState();
}

class _PageAddPeyakitState extends State<PageAddPeyakit> {
   GlobalKey<HtmlEditorState> keyCiri = GlobalKey();
                      ...
                      FadeAnimation(
                        ...
                        Container(
                          ...
                          child: FlatButton(
                            ...
                            onPressed: () async {
                              final ciri = await keyCiri.currentState.getText();
  ...
  simpanData(context) async {
    ...
    var res = await http.post(Uri.encodeFull(Config.ipWeb + "addDesease"),
        body: body,
        headers: {
          'Authorization': 'Bearer $token',},);
